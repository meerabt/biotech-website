...
const products = [
  {
    ...
    tab: "Medical Equipments", // NEW: tab name for navigation
  },
  {
    ...
    tab: "Lab Equipments", // NEW: tab name for navigation
  },
];
  ...
  return (
    <div className="bg-white p-3">
      <section className="max-w-7xl mx-auto py-10 text-primarydark rounded-xl">
        ...
        <motion.div
          className="space-y-8 mb-20 gap-10"
          ...
          {products.map((product, index) => (
            ...
            >
              <motion.div
                ...
                className="flex flex-col sm:flex-row sm:h-[300px] gap-6 mt-10 bg-gray-50 p-4 rounded-md shadow-xl cursor-pointer border border-gray-200"
                whileHover={{ y: -10 }}
